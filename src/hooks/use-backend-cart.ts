...
// //       if (!token || !userId) {
// //         console.log("⏭️  Skipping cart fetch: not authenticated")
// //         setCart(null)
// //         setLoading(false)
// //         return
// //       }

// //       // Use Next.js proxy endpoint instead of direct backend call
// //       const url = `/api/cart?where[userId][equals]=${userId}`
...
// //         if (!token || !cart?.id) {
// //           setError("Not authenticated or cart not found")
// //           return false
// //         }
...
// //       }
// //     },
// //     [getAuthToken, cart?.id, removeFromCart]
// //   )
...
//       // Use the correct endpoint: /api/customer/cart
...
//       }
//     },
//     [getAuthToken, getUserId, cart?.items]
//   )
...
//       }
//     },
//     [getAuthToken, getUserId, cart?.items, removeFromCart]
//   )
