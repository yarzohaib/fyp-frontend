...
//   return (
//     // Background: #F2F0E5
//     <div className={`min-h-screen p-4 sm:p-6 lg:p-0`} style={{ backgroundColor: COLOR_BACKGROUND }}>
...
//             <div className="p-3 rounded-lg" style={{ backgroundColor: COLOR_ACCENT }}>
//               <Package className="w-6 h-6 text-white" />
//             </div>
//             <div>
//               {/* Heading: font-serif, font-medium, Primary color */}
//               <h1 className="text-3xl font-serif font-medium" style={{ color: COLOR_PRIMARY }}>
//                 Order Management
//               </h1>
...
//             <div style={{ backgroundColor: COLOR_ACCENT }} className="text-white p-4 flex items-center justify-between">
//                 <TrendingUp className="w-5 h-5 opacity-80" />
//                 <div>
//                     <div className="text-2xl font-bold text-right">{orders.length}</div>
...
//                 <div className={`${statusBgColor} text-white p-4 flex items-center justify-between`}>
...
//         <div className="mb-8 flex gap-2 flex-wrap p-4 bg-white rounded-xl shadow-sm border border-gray-200">
//           <Button
//             onClick={() => setFilter("all")}
//             className={`rounded-lg font-medium px-4 py-2 text-sm transition-all duration-300 ${
//               filter === "all"
...
//                 <Loader2 className={`w-8 h-8 animate-spin mx-auto mb-3`} style={{ color: COLOR_ACCENT }}/>
...
//               <Package className={`w-12 h-12 mx-auto mb-3`} style={{ color: COLOR_ACCENT }} />
//               <p className={`text-gray-800 font-serif font-medium text-lg mb-1`}>
//                 No orders found
//               </p>
...
//                     <CardTitle className="text-xl font-serif font-medium" style={{ color: COLOR_PRIMARY }}>
...
//                     </div>
//                   </div>
//                   <Badge className={`rounded-full px-3 py-1 font-semibold text-xs border ${getStatusColor(order.orderStatus)}`}>
//                     {getStatusLabel(order.orderStatus)}
//                   </Badge>
//                 </div>
//               </CardHeader>

//               <CardContent className="pt-5 pb-5 px-4 sm:px-6 bg-white grid grid-cols-1 lg:grid-cols-3 gap-6">
                
//                 {/* Customer Info Card */}
//                 <div className="lg:col-span-1 p-4 bg-gray-50 rounded-lg border border-gray-200">
//                   <h3 className="font-serif font-medium text-base text-gray-800 mb-3 border-b pb-2">
//                     Customer Details
//                   </h3>
...
//                       <div
//                         key={idx}
//                         className="flex justify-between items-center p-3 bg-white rounded-md border border-gray-200 text-sm"
//                       >
//                         <div>
...
//                           </p>
//                         </div>
//                         <p className="font-semibold text-base" style={{ color: COLOR_ACCENT }}>
...
//                         <label className="block text-gray-800 font-serif font-medium mb-2 text-base">
//                             Update Order Status
//                         </label>
...
//                                     className="w-full px-3 py-2 text-sm rounded-lg border border-gray-300 text-gray-800 font-medium appearance-none bg-white cursor-pointer hover:border-gray-500 focus:border-gray-500 focus:outline-none transition-colors"
//                                 >
//                                     {ORDER_STATUS_OPTIONS.map((opt) => (
...
//                                     <span className="font-medium whitespace-nowrap">Updating...</span>
//                                 </div>
//                             )}
//                         </div>
//                     </div>
...
//                                 <span className="font-serif font-semibold text-lg" style={{ color: COLOR_PRIMARY }}>Grand Total:</span>
//                                 <span className="font-serif font-extrabold text-2xl" style={{ color: COLOR_ACCENT }}>
...
//               className={`rounded-lg px-4 py-2 text-sm font-medium border border-gray-300 bg-white text-gray-700 hover:bg-gray-100 disabled:opacity-50 disabled:cursor-not-allowed transition-colors`}
//             >
//               Previous
//             </Button>
                  ...
                  <div className="space-y-2 text-xs sm:text-sm">
                    ...
                    {order.shippingAddress?.phone && (
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-gray-800 break-words">{order.shippingAddress.phone}</span>
                        </div>
                    )}
                  </div>
                  ...
                  {order.shippingAddress && (
                    <div className="mt-3 sm:mt-4 pt-3 sm:pt-4 border-t border-gray-200">
                        <div className="flex items-start gap-2">
                            ...
                            <div className="text-xs text-gray-600 leading-normal break-words">
                                <p className="font-semibold mb-0.5">
                                    {order.shippingAddress.firstName} {order.shippingAddress.lastName}
                                </p>
                                <p>{order.shippingAddress.street}</p>
