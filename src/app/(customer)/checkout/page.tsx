...
//     product: item.product,        // Already a string
//     quantity: item.quantity,
//     unitPrice: item.price,        // Use 'price' field
//     lineTotal: item.lineTotal,
// }))
//             // Build checkout data matching backend expectations
//             // The backend expects shippingAddress from the request body
//             const checkoutData = {
...
//                                     const productTitle = typeof item.product === 'object' && item.product !== null && 'title' in item.product
                    ...
                    <div className="lg:col-span-2">
                        <form onSubmit={handleCheckout} className="space-y-6">
                            ...
                            <button
                                type="submit"
                                disabled={processing || cartItems.length === 0}
                                className="w-full bg-[#BB4E2C] hover:bg-[#1a3126] disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-bold py-4 px-6 rounded-lg transition duration-200 text-lg"
                            >
                                {processing ? 'Processing...' : `Place Order (Rs. ${totals.total.toFixed(2)})`}
                            </button>
                        </form>
