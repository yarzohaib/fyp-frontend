...
// import type { ProductTabsProps } from "@/lib/Types"
...
//                     <TabsTrigger value="reviews">Reviews and Ratings</TabsTrigger>
//                 </TabsList>
...
//                     <div className="prose prose-sm max-w-none text-foreground/70">
//                     {/* Add ratings in form of stars then reviews */}
//                         <p>
//                             {reviews || "Material information will be displayed here. Please check back soon for complete details."}
//                         </p>
//                     </div>
//                 </TabsContent>
//             </Tabs>
